...
export function buildSqlQuery(query: string, metadataJson: string, optionsJson: string | undefined): string;
export function hydrateResults(rowsJson: string, metadataJson: string): string;
