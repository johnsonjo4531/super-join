/**
 * Super-join component example for Deno
 * 
 * This demonstrates how to use the WASM component with Deno's native
 * WebAssembly Component Model support.
 * 
 * Run with: deno run --allow-read --allow-env --allow-run src-js/__component__/deno_example.ts
 */

import { instantiate } from './src-js/__component__/super_join.js';
...
// Run examples
async function main() {
  console.log('Super-join Component Examples for Deno');
  console.log('=======================================');
